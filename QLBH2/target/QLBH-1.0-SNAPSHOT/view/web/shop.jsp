        ...
        <div class="shop__option">
            <div class="row">
                <div class="col-lg-7 col-md-7">
                    ...
                    <select id="categorySelect" onchange="sendCategory()">
                        ...
                        <c:if test="${tontai != 0}">          
                            <div class="col-lg-3 col-md-6 col-sm-6" >
                                ...
                                <div class="product__item">
                                    ...
                                    <div class="product__item__pic set-bg" ><a href="./pagecontrol?page=shop_details&productId=${i.getMaSanPham()}"><img src="${i.getHinhAnh()}"></a>
